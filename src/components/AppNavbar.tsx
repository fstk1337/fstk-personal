...
const AppNavbar = () => {
    ...
    return (
        <>
                        ...
                        <NavStack direction='row' gap='40px'>
                            {navItems.map((item) => (
                                <NavBtn key={item.text} variant='text'>
                                    <AppNavLink to={item.path}>{item.text}</AppNavLink>
                                </NavBtn>
                            ))}
                            <ContactBtn
                                id='basic-button'
            ...
            <AppMenu anchorEl={anchorEl} open={open} onClose={handleClose} />
            <MenuDrawer anchor='right' open={menuOpen} onClose={toggleMenu}>
                {list()}
            </MenuDrawer>
        </>
    );
